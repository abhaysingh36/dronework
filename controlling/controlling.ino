...
void setThrottleValues(int m1, int m2, int m3, int m4) {
  ...
  int speed1=smoothThrottle(lastThrottle[0], m1);
  int speed2=smoothThrottle(lastThrottle[1], m2);
  int speed3=smoothThrottle(lastThrottle[2], m3);
  int speed4=smoothThrottle(lastThrottle[3], m4);
